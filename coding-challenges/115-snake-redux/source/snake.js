class Snake {
  ...
  move(dir) {
    ...
    console.log(dir, prevDir, dirs.indexOf(dir));
    if (dir === prevDir || prevDir === dirs[(dirs.indexOf(dir) + 2) % 4]) {
      console.log('Ignoring move', dir, this.dir, prevDir, pendingMoves);
      return;
    }
    
    if (pendingMoves.length === 0) {
      pendingMoves.push(dir);
      console.log('First pending move:', dir);
    } else {
      pendingMoves[1] = dir;
      console.log('Second pending move:', dir);
    }
  }
